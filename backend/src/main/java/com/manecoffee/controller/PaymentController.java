...
import com.manecoffee.service.OrderService;
import com.manecoffee.service.RazorpayService;
import com.manecoffee.service.UserService;
...
public class PaymentController {
    ...
    private final com.manecoffee.service.CartService cartService;
    private final com.manecoffee.repository.CheckoutSelectionRepository selectionRepo;
    private final com.manecoffee.repository.AddressRepository addressRepo;
    ...
    public PaymentController(RazorpayService razorpayService, OrderService orderService, UserService userService,
            ...
            com.manecoffee.service.CartService cartService,
            com.manecoffee.repository.CheckoutSelectionRepository selectionRepo,
            com.manecoffee.repository.AddressRepository addressRepo) {
    ...
    public ResponseEntity<?> createOrder(@RequestParam("email") String email) {
        try {
            ...
            com.manecoffee.entity.CheckoutSelection selection = selectionRepo.findByUser(user).orElse(null);
            if (selection == null) {
    ...
    public ResponseEntity<?> verifyPayment(@RequestBody Map<String, String> body) {
        try {
            ...
            Map<String, Object> resp = new HashMap<>();
            resp.put("order", new com.manecoffee.dto.OrderDTO(updated));
            return ResponseEntity.ok(resp);
