...
import com.manecoffee.dto.OrderDTO;
...
public class OrdersController {
    ...
    private com.manecoffee.repository.OrderStatusHistoryRepository orderStatusHistoryRepo;
    ...
    public ResponseEntity<?> getOrderStatusHistory(@PathVariable Long orderId) {
        try {
            ...
            var dtoList = historyList.stream()
                    .map(h -> new com.manecoffee.dto.OrderStatusHistoryDTO(h.getStatus(), h.getChangedAt()))
