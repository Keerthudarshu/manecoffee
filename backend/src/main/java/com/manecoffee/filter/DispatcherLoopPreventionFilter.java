...
public class DispatcherLoopPreventionFilter extends OncePerRequestFilter {
    ...
    private static final String DISPATCHER_LOOP_ATTR = "com.manecoffee.filter.dispatcherLoopDetected";
    private static final String FORWARD_CHAIN_ATTR = "com.manecoffee.filter.forwardChain";
