          ...
          <CartProvider>
            <div className="App overflow-x-hidden">
              ...
              <ErrorBoundary>
                ...
                <a href="https://wa.me/919019445168" style={{ position: 'fixed', bottom: '80px', right: '20px', background: '#25D366', color: 'white', padding: '10px 20px', borderRadius: '50px', display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none', fontWeight: 'bold', zIndex: 1000, boxShadow: '0px 4px 6px rgba(0,0,0,0.2)', transition: 'transform 0.3s ease' }}>
